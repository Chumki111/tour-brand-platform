...
const SignIn = () => {
    ...
    return (
        ...
        <div className="w-1/2 min-h-full bg-black relative overflow-hidden hidden lg:block">
          ...
          <span className="bg-white w-32 h-32 -top-8 -left-8 rounded-full absolute z-20 group-hover:w-56 group-hover:h-56 duration-500"></span>
        ...
        <form onSubmit={handleLogin} className="p-8 flex-1">
          ...
          <p className="mb-3">Don't have an account?<Link to="/register" className="underline">Register</Link></p>
        </form>
      </div>
