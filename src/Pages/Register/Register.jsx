...
const Register = () => {
    return (
        ...
        {/* register form  */}
        <form className={`p-8 w-full lg:w-1/2 duration-500`}><h1 className="backdrop-blur-sm text-4xl pb-4">Register</h1>
          ...
          <p className="mb-3 text-center">Already have an account?<Link className="underline">Login</Link></p>
          <hr />
        ...
        {/* img */}
        <div className={`absolute w-1/2 h-full top-0 z-50 min-h-full duration-500 overflow-hidden hidden lg:block  bg-sky-50}`}><img src="https://source.unsplash.com/random" className="object-cover h-full" alt="img"/></div>
